  ...
  <div class="elUploadContainer">
    <el-upload ref="upload" action="#" list-type="picture-card" :auto-upload="false" :multiple="true" :file-list="fileList" drag :on-change="handleChange" :limit="getLimit" :on-exceed="limitExceed" accept=".jpg,.png">
      ...
      <div slot="file" slot-scope="{file}">
        ...
        <img class="minWatermark" v-if="watermark.type == 2" :src="watermark.url" :style="getMinWaterImgStyle">
    ...
    <el-dialog :visible.sync="dialogVisible" width="540px" append-to-body>
      <div class="maxwatermarkContaier">
        ...
        <img class="maxwatermark" v-if="watermark.type == 2" :src="watermark.ossimageurl" :style="getMaxWaterImgStyle" ondragstart="return false;">
      </div>
    </el-dialog>
  </div>
</template>
...
<script>
import { uploadImage } from "@/api/amazon/amazonListing";
