<template>
  <div>
    ...
    <u-table-column label="任务名称" align="center" width="150" prop="taskName" />
    ...
    <u-table-column label="操作" align="center" width="200" prop="addTime">
      <template #default="{ row }">
        <el-button @click="downReport(row.id)" type="text" v-if="row.status === 2">下载报告</el-button>
      </template>
    </u-table-column>
  </div>
</template>
...
<script>
import { downReport } from "@/api/selection/productLibrary"
export default {
